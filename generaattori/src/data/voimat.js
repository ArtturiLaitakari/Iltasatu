export const voimat = {
  ...
  'tarot': {
    ...
    peruskyvyt: [
      ...
      {
        nimi: 'Yhdistä sijainteja',
        kuvaus: 'Luo pysyvä portaali eri paikkojen tai varjojen välille. Portaali imee maagista energiaa ympäriltään.',
        taso: 3
      },
      {
      ...
      {
        nimi: 'Luo avaruutta',
        kuvaus: 'Avaa ovi todellisuuksien väliseen potentiaaliin ja luo oma varjo. Saat 2 uutta edistynyttä kykyä (yhteensä 3).',
        taso: 5
      }
    ],
    edistyneet: [
