...
export const ammatit = {
  fantasia: {
    ...
    mystinen: [
      ...
      { id: 'todellisuuden-mestari', nimi: 'Todellisuuden mestari', kuvaus: 'Manipuloi pehmeää kaaoksen todellisuutta hienovaraisesti.', voima: 'heijastuksen hallinta' },
      { id: 'kaaosmestari', nimi: 'Kaaosmestari', kuvaus: 'Skannaa pehmeää potentiaalia kaaossäikeillä, tuo ja vie asioita niillä.', voima: 'kaaossäikeet' },
      { id: 'tarot-mestari', nimi: 'Tarot mestari', kuvaus: 'Luo yhteys kuvan ja asian välillä, matkaa korttien avulla ja luo mahtiesineitä.', voima: 'tarot' },
